...
def encrypt(p,k=None,expk=None,fault=0x00,floc=0):
  ...
  # final round
 # print printmatrix(add_roundkey(shiftrows( subbytes(state)), get_roundkey(expanded_key,10)))
...
def get_roundkey(expanded_key,r):
  ...
  #print printmatrix(to_matrix(key))
...
def gen_cipher():
  ...
  print "\nEnter hex input: \n"
  plain_text = int(raw_input(),16)
  print "\nEnter 192-bit key: \n"
  kay = int(raw_input(),16)
  b = encrypt(plain_text,kay)
  #c = decrypt(b,kay)
  a = str(hex(b))
  #d = str(hex(c))
  print "\nYour encrypted data is "+a
  #print "Decrypted data "+d
  print "\nEncryption done sucessfully\n"

  #print "PROJECT DONE BY RICHA, BHAGYA AND AAKANKSHA"
